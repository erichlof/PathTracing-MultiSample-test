...
var increaseSamples = false;
var decreaseSamples = false;
var frameBlendingAmount = 0.5;
var increaseFrameBlend = false;
var decreaseFrameBlend = false;
...
function animate() {
        ...
        if (useGenericInput) {
                ...
                if (keyboard.pressed('equals') && !keyboard.pressed('dash')) {

                        increaseSamples = true;
                }
                if (keyboard.pressed('dash') && !keyboard.pressed('equals')) {

                        decreaseSamples = true;
                }
                if (keyboard.pressed('period') && !keyboard.pressed('comma')) {

                        increaseFrameBlend = true;
                }
                if (keyboard.pressed('comma') && !keyboard.pressed('period')) {

                        decreaseFrameBlend = true;
                }
                ...
                if (increaseSamples) {
                        samplesPerFrame += 0.5;
                        if (samplesPerFrame > 100.0)
                                samplesPerFrame = 100.0;
                        pathTracingUniforms.uSamplesPerFrame.value = Math.floor(samplesPerFrame);
                        cameraIsMoving = true;
                        increaseSamples = false;
                }
                if (decreaseSamples) {
                        samplesPerFrame -= 0.5;
                        ...
                        pathTracingUniforms.uSamplesPerFrame.value = Math.floor(samplesPerFrame);
                        cameraIsMoving = true;
                        decreaseSamples = false;
                }

                if (increaseFrameBlend) {
                        frameBlendingAmount += 0.01;
                        if (frameBlendingAmount > 0.98)
                                frameBlendingAmount = 0.98;
                        pathTracingUniforms.uFrameBlendingAmount.value = frameBlendingAmount;
                        cameraIsMoving = true;
                        increaseFrameBlend = false;
                }
                if (decreaseFrameBlend) {
                        frameBlendingAmount -= 0.01;
                        if (frameBlendingAmount < 0.0)
                                frameBlendingAmount = 0.0;
                        pathTracingUniforms.uFrameBlendingAmount.value = frameBlendingAmount;
                        cameraIsMoving = true;
